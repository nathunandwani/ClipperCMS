		...
		<div id="tabGeneral">
			...
			<table border="0" cellspacing="0" cellpadding="3">
			  ...
			  <tr id="editname" style="display:<?php echo $_GET['a']=='87'||(isset($usernamedata['oldusername']) && $usernamedata['oldusername']!=$usernamedata['username']) ? $displayStyle : 'none' ; ?>">
				...
				<td>&nbsp;</td>
				<td><input type="text" name="newusername" class="inputBox" value="<?php echo $modx->html(isset($_POST['newusername']) ? $_POST['newusername'] : $usernamedata['username']); ?>" onchange='documentDirty=true;' maxlength="100" /></td>
			  </tr>
			  <tr>
