...
$_lang['configcheck_locale_LC_ALL_warning'] = 'Языковой стандарт LC_ALL установлен неправильно';
$_lang['configcheck_locale_LC_ALL_warning_msg'] = 'LC_ALL, определенный в config.inc.php не определяется как текущим языковым стандартом для LC_ALL.';
$_lang['configcheck_locale_LC_NUMERIC_warning'] = 'Языковой стандарт LC_NUMERIC установлен неправильно';
$_lang['configcheck_locale_LC_NUMERIC_warning_msg'] = 'LC_NUMERIC, определенный в config.inc.php не определяется как текущим языковым стандартом для LC_NUMERIC.';
...
$_lang['configcheck_error_handling_silent'] = 'Ошибки анализатора должны быть показаны на экране';
$_lang['configcheck_error_handling_silent_msg'] = 'Параметр конфигурации <strong> "Как выводить сообщения об ошибках PHP/SQL на экран" </strong> установлен таким образом, что ошибки отображаются на экране. Этот режим рекомендуется для разработки, но не для действующих сайтов.';
...
$_lang["database_table_engine"] = 'Ядро СУБД';
...
$_lang["datepicker_year_range"] = 'Смещение лет: ';
$_lang["datepicker_year_range_message"] = 'Число прошлых лет, которое будет показано в окне выбора даты.';
$_lang["date_format"] = 'Формат даты:';
$_lang["date_format_message"] = 'Выберите формат даты, который будет использован в системе управления.';
$_lang["time_format"] = 'Формат времени:';
$_lang["time_format_message"] = 'Выберите формат времени, который будет использован в системе управления.';
...
$_lang['default_child_template_use_system_setting'] = 'Использовать системные настройки';
...
$_lang['package_manager'] = 'Менеджер пакетов';
$_lang['package_manager_upload_byurl_text'] = 'Загрузить пакет вручную, путем ввода в URL';
$_lang['package_manager_upload_byfile_text'] = 'Вручную загрузить файл пакета с локального компьютера';
$_lang['package_manager_upload_byfolder_text'] = 'Вручную указать папку пакета на данном веб-сервере';
$_lang['package_manager_upload_byurl_label'] = 'Загрузить с URL';
$_lang['package_manager_upload_byfile_label'] = 'Загрузить с локального компьютера';
$_lang['package_manager_upload_byfolder_label'] = 'Загрузить из папки';
$_lang['package_manager_tagsinrepo'] = 'Теги, используемые в этом репозитарии';
$_lang['package_manager_restart'] = 'Вернуться в начало менеджера пакетов';
$_lang['package_manager_fetchpackage'] = 'Получить пакет';
$_lang['package_manager_search'] = 'Искать';
$_lang['package_manager_upload'] = 'Загрузить';
$_lang['package_manager_retry'] = 'Повторить';
$_lang['package_manager_install'] = 'Установить';
$_lang['package_manager_autoinstall_html0'] = '<div><p><strong>Используйте следующий код плагина для автоматического установки в процессе разработки. </ STRONG> Добавить к событию OnWebPageInit.</p><pre>';
$_lang['package_manager_autoinstall_html1'] = '</pre></div>';
$_lang['package_manager_error_internal'] = 'Внутренняя ошибкa при загрузке. Пожалуйста, попробуйте еще раз.';
$_lang['package_manager_error_filesize'] = 'Ваш сервер не настроен принимать файлы такого размера. Обратитесь к администратору сервера и попросите увеличить максимальный размер закачиваемого файла..';
$_lang['package_manager_check_perms'] = 'Проверьте права доступа';
...
$_lang["function_no_longer_impl"] = 'Извините! Функция удалена.';
$_lang["function_no_longer_impl_message"] = 'Эта функция более не доступна.';
$_lang["go"] = 'Перейти';
...
$_lang['role_duplicates_not_allowed'] = 'Роль с данным именем уже существует.';
...
$_lang['rss_len_title'] = 'Длина RSS ленты';
$_lang['rss_len_message'] = 'Сколько записей должно отображаться на сайте из RSS-канала';
...
$_lang['error_handling_deprecated_label'] = 'Как обрабатывать устаревшие PHP функции (PHP >= 5.3)';
$_lang['error_handling_deprecated_0'] = 'Разрешить устаревшие функции. Не показывать предупреждения.';
$_lang['error_handling_deprecated_1'] = 'Разрешить устаревшие функции. Показывать в Событиях и Протоколе';
$_lang['error_handling_deprecated_2'] = 'Запретить устаревшие функции. Вывести ошибку и остановиться';
$_lang['error_handling_silent_label'] = 'Как выводить сообщения об ошибках PHP/SQL на экран.';
$_lang['error_handling_silent_0'] = 'Показывать на экране';
$_lang['error_handling_silent_1'] = 'Не отображать, Выполнение останавливается с пустым экраном';
$_lang['jquery_url_label'] = 'jQuery URL';
$_lang['jquery_plugin_dir'] = 'Директория плагина jQuery';
$_lang['jquery_noconflict'] = 'Использовать jQuery.noConflict()';
$_lang['file_browser_title'] = 'Файл-менеджер';
$_lang['actions'] = 'Действия';
$_lang['docid_visibility'] = 'Видимость идентификаторов ресурсов в дереве сайта';
$_lang['docid_visibility_message'] = 'Управление видимостью идентификаторов ресурсов / документов отображаемых в дереве сайта.';
$_lang['default_child_template'] = 'Шаблон по умолчанию для дочерних ресурсов';
$_lang['restrict_children'] = 'Ограничить шаблоны дочерних ресурсов';
$_lang['allowed_child_templates'] = 'Разрешить шаблоны дочерних ресурсов';
$_lang['template_rules_tv_label'] = 'ТВ, для использования в специфичных правилах шаблона ресурса';
?>