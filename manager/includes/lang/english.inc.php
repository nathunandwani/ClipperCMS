...
$_lang["user_upload_message"] = ' If you wish to stop this User uploading any filetypes in this category, make sure that the \'Use System Configuration Setting\' checkbox is not ticked and leave the field blank.';
...
$_lang['help_tag'] = 'tag';
$_lang['help_fields'] = 'Inserts resource fields or template variables specific to the page being displayed.';
$_lang['help_crossrefs'] = 'Inserts resource fields or template variables from another page. The docid can be a docid, \'parent\' or \'ultimateparent\'.';
$_lang['help_snippets_cached'] = 'Inserts the output of a snippet into your page. If the page is cached, the result will be saved in the page\'s cache file.';
$_lang['help_snippets_uncached'] = 'Inserts the output of a snippet into your page. The snippet\'s output will not be cached and will be run on each page request even if the page is cached.';
$_lang['help_chunks'] = 'Inserts a chunk into your page.';
$_lang['help_settings'] = 'Inserts the value of a system setting into your page.';
$_lang['help_internal_links'] = 'Makes a link to another document in your '.CMS_NAME.' site.';
$_lang['help_timing'] = 'Shows how long it took to create the current page.';
$_lang['help_placeholder'] = 'Acts as a placeholder for content generated by a snippet or plugin. Usage will be detailed in the snippet or plugins documentation.';
$_lang['help_modifiers'] = 'Output modifiers (strtolower, strtoupper, ucwords, ucfirst, strip_tags, urlencode, rawurlencode, html, limit(n), ellipsis(n), date).';
$_lang['webuser_hash_method_title'] = 'Password hashing method for webusers';
$_lang['webuser_hash_method_message'] = 'Salted SHA1 is more secure and recommended, but MD5 may be required for some legacy MODx Extras. This setting only applies when creating or editing a webuser. Changing the setting does not affect existing web users and both the Clipper core and WebUsers will accept either method for existing web users.';
$_lang['smtp'] = 'SMTP';
